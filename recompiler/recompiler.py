...
with open('playable_health_v2.2.json') as json_file:
...
#1) Recompile nodes into d3-readable array & populate ID:name mapping dictionary
...
#2) Recompile edges into de3-readable format
...
with open('../startup/playable_health_v6.json', 'w') as json_file:
